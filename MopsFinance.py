            ...
            with pymssql.connect( server = "8AEISS01", user = "sap_user", password = dectry(pwd_enc) ) as conn:
                with conn.cursor() as cursor:
                    try:
                        ...
                        return round(cursor.fetchall()[0][0], -3) 
                    except:
                        return 0        
        else:
...
cfg_fname = r"D:\My Document\Python\webcrawler\config\config.json"
